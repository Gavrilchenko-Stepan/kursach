...
namespace WinForms
{
    public partial class NewChatForm : Form
    {
        ...
        private void LoadDepartments()
        {
            ...
            // Сейчас создаем тестовые данные для демонстрации
        ...
        // Внутренний класс для хранения информации об отделе
